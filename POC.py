...
class POC:
    ...
    def calcPOC(self, block_ref,block_curr ,window, mb_x, mb_y):
        ...
        R2  = abs(R1) # Menghitung magnitudo dari hasil korelasi fase
        R2[R2 == 0] = 1e-31 # Mengganti nilai-nol dalam R2 dengan nilai yang sangat kecil untuk menghindari pembagian oleh nol
        R   = R1/R2 # Menghitung korelasi fase normalisasi
        r   = ifft2(R) # Menghitung invers transformasi Fourier dari hasil korelasi fase normalisasi
        r   = abs(r) # Menghitung magnitudo dari hasil invers transformasi Fourier
        r   = fftshift(r) # Menggeser hasil invers transformasi Fourier agar titik nol berada di tengah
